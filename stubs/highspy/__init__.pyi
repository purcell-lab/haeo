...
class HighsIis:
    ...
    @property
    def col_index(self) -> list[int]: ...
    @property
    def row_index(self) -> list[int]: ...
    @property
    def col_bound(self) -> list[int]: ...
    @property
    def row_bound(self) -> list[int]: ...
...
class HighsInfo:
    ...
    @property
    def ipm_iteration_count(self) -> int: ...
    @property
    def crossover_iteration_count(self) -> int: ...
    @property
    def qp_iteration_count(self) -> int: ...
    @property
    def pdlp_iteration_count(self) -> int: ...
    @property
    def basis_validity(self) -> int: ...
...
class Highs:
    ...
    def __init__(self) -> None: ...
    @overload
    def setOptionValue(self, option: Literal["solver"], value: str) -> HighsStatus: ...
    @overload
    def setOptionValue(self, option: Literal["presolve", "parallel"], value: str) -> HighsStatus: ...
    @overload
    def setOptionValue(
        self, option: Literal["simplex_strategy", "simplex_scale_strategy"], value: int
    ) -> HighsStatus: ...
    @overload
    def setOptionValue(self, option: Literal["output_flag", "log_to_console"], value: bool) -> HighsStatus: ...
    @overload
    def setOptionValue(self, option: str, value: bool | int | float | str) -> HighsStatus: ...
    @overload
