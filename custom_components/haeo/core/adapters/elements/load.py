...
def _stats_outputs(
    ...
    return {
        ...
        LOAD_HORIZON_MARGINAL_COST: OutputData(
            type=OutputType.COST, unit="$", values=cost_per_step, direction="-", state=horizon_cost
        ),
        ...
        LOAD_HORIZON_AVERAGE_MARGINAL_PRICE: OutputData(
            type=OutputType.PRICE, unit="$/kWh", values=avg_cost_per_step, state=horizon_avg_cost
        ),
        ...
        LOAD_NEXT_24H_MARGINAL_COST: OutputData(
            type=OutputType.COST, unit="$", values=cost_24h_per_step, direction="-", state=next_24h_cost
        ),
        ...
        LOAD_NEXT_24H_AVERAGE_MARGINAL_PRICE: OutputData(
            type=OutputType.PRICE, unit="$/kWh", values=avg_cost_24h_per_step, state=next_24h_avg_cost
        ),
    }
